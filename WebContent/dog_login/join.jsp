          ...
          <div class="container-login">
            ...
            <div class="login-box">
              <div class="login-form">
                <form action="./login.jsp" id="login-form" method="post">
                  <input name="_csrf_token" type="hidden" value="">            
                   <!-- 아이디 -->
                    ...
                    <!-- 비밀번호확인 -->
                    <div class="l-row l-input">
                      <input data-cy="password" id="userPassword" name="userPassword" placeholder="비밀번호확인" type="password">
                    </div>
                   ...
                   <select id="gender" class="sel">
                    ...
                    <div class="l-row l-input">   
                  <a class="button button-80 button-round button-mouse-border" href="main.jsp" type="submit">
